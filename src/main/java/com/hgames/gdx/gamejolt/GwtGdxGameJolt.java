...
/**
 * An implementation of {@link GdxGameJolt} that is compatible with Google's GWT
 * compiler.
 * 
 * @author smelC
 * 
 * @see NonGwtGdxGameJolt An implementation of {@link GdxGameJolt} that is
 *      suited for non-GWT contexts.
 */
public class GwtGdxGameJolt extends GdxGameJolt {
	 ...
	 */
	public GwtGdxGameJolt(int gameID, String gamePrivateKey, String username, String userToken,
			IGdxGameJoltResponseListener listener) {
		super(gameID, gamePrivateKey, username, userToken, listener);
	}

	@Override
	protected String md5(String s) throws Exception {
		return native_md5(s);
	}

	/*
	 * Code has been taken from http://www.webtoolkit.info/javascript-md5.html,
	 * without any change. This code's license information is here:
	 * http://www.webtoolkit.info/license1/index.html.
	 * 
	 * The license' summary is http://creativecommons.org/licenses/by/2.0/uk/
	 * which authorizes to build upon this material, for any purpose, even
	 * commercially.
	 * 
	...
	private static native String native_md5(String string) /*-{
